...
struct LegacySprite
{
    ...
    int volume;
    bool draggable; // <--- NEW: FOR SET DRAG MODE

    LegacySprite() : name("Sprite1"), x(0), y(0), direction(90), visible(true), size(100), say_text(""), is_thinking(false), say_end_time(0), volume(100), draggable(true) {}
};
...
struct AppState
{
    ...
    int selected_sprite, selected_tab, selected_category;
